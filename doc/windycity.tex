% Last modified: Wed 27 Mar 2019 03:24:13 PM CDT
...
third-party style files and proceed accordingly. Under \begingroup
\hypersetup{urlcolor=blue} \href{http://www.tug.org/texlive}{TeXLive},
\endgroup the directory structure should look like this:
...
\path{texmf}. Its location will depend on your system and preferences.
For a one-off compilation, say, to give Windy City a trial run on a
single document, you can copy Windy City's files to the document's
root directory---no need for \textit{bbx}, \textit{cbx}, and
\textit{lbx} subdirectories.
...
database. How to do that will depend on your system and, perhaps,
