% Last modified: Thu 25 Mar 2021 09:39:06 AM CDT
...
The style supports a second tier of editors after titles. In your
bibliography database, make sure to list them in the proper order:
\bibfield{editor} precedes \bibfield{editora}, and \bibfield{editora}
precedes \bibfield{editorb}. When they apply to a \bibfield{title},
second tier editors never print in the author's position. They print
after \bibfield{title}, even when the first occupies the author's
position.
