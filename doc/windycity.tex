% Last modified: Wed 07 Oct 2020 07:17:56 PM CDT
...
Like \cmd{footfullcite} but suppresses the author's position.

\cmditem{fullcite*}[prenote][postnote]{key}

Like \cmd{fullcite} but suppresses the author's position.
...
\item[authtype] This field takes just two values, \textit{anon} (to
print an anonymous author's name in brackets) and \textit{anon?} (to
add a question mark inside the brackets). From \textit{CMOS}
\ref{14.79}:
...
\section{Editors, Translators, Friends}
\label{edtrans}
...
\toprule
compiler & compiler & updater & updater\\
comped & compiler and editor & upcomp & updater and compiler\\
comprev & compiler and reviser & uped & updater and editor\\
comptrans & compiler and translator & uprev & updater and reviser\\
compup & compiler and updater & uptrans & updater and translator\\
edcomp & editor and compiler & edup & editor and updater\\
transcomp & translator and compiler & transup & translator and updater\\
reviser & reviser & &\\
revcomp & reviser and compiler & &\\
reved & reviser and editor & &\\
revtrans & reviser and translator & &\\
revup & reviser and updater & &\\
