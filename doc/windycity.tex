% Last modified: Tue 22 Jan 2019 06:34:27 PM CST
...
information about a work. An example from \textit{CMS} \ref{14.105}
stores the following text there: ``from materials compiled by John M.
Manly and Edith Richert, with the assistance of Lilian J. Redstone et
al.'' This prints after the editor's position without intervening
punctuation. See Section \ref{entryops} for the resulting output.
...
\bibfield{editorctype} (for \bibfield{editorc}).\footnote{For an
example of a bibliography database entry with \bibfield{editora}, see
Section \ref{collorder} and \bibfield{carson2014} in
\file{windycity.bib}.}
