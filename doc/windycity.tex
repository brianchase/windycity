% Last modified: Fri 05 Nov 2021 05:43:24 PM CDT
...
\textit{no date}) seems unnecessary or distracting. Omit the year with
...
To omit the year from parenthetical citations, as in the example
below, use the custom command \cmd{parenauth}. See section
\ref{parenauth}:
...
\noindent An example with \cmd{parencite}:
