% Last modified: Sun 21 Oct 2018 04:18:39 PM CDT
...
has no requirements beyond those of \biblatex. Most of its development
occurred under \biblatex versions 2.7 and 2.8, with only minor updates
and bug fixes in the years since. The current release, also very
minor, nonetheless requires \biblatex version 3.8 or later.
...
you could also use \bibtype{bookinbook}.}
...
\begin{itemize}
\AtNextCitekey{\togglefalse{transfirst}}
\item[N] \fullcite{doe2010}

\AtNextCitekey{\togglefalse{transfirst}}
\item[B] \bibentry{doe2010}
...
\begin{itemize}
\AtNextCitekey{\togglefalse{transfirst}}
\item[N] \fullcite{smith2002}

\AtNextCitekey{\togglefalse{transfirst}}
\item[B] \bibentry{smith2002}
\end{itemize}
