% Last modified: Fri 09 Nov 2018 03:45:08 PM CST
...
\bibfield{shorthand}---the \bibfield{shorthand} replaces
...
first. However, entries with the option \bibfield{transfirst} reverse
this order: Their translators print first. If a work's translators and
editors are identical, using \bibfield{transfirst} reverses the order
...
%\bibfield in Section \ref{datafields} and \ref{14.215}.
...
%example appears below, in \ref{14.215}.
