% Last modified: Sat 11 Jul 2020 07:37:32 PM CDT
...
For an example in \textit{CMOS} from table \ref{table:ed}, we need
turn to the bibliography. This will do:
...
Windy City lets you assign as many as three, that is, if you
