% Last modified: Tue 02 May 2023 07:46:31 AM CDT
...
\bibfield{journal} (and its equivalent \bibfield{journaltitle}),
\bibfield{maintitle}, \bibfield{origtitle}, \bibfield{shortbooktitle},
\bibfield{shorthand}, \bibfield{shorttitle}, and
\bibfield{shortmaintitle}.
...
\bibfield{booktitle}, \bibfield{issuetitle}, \bibfield{journal} (and
its equivalent \bibfield{journaltitle}), \bibfield{maintitle},
\bibfield{origtitle}, \bibfield{shortbooktitle}, \bibfield{shorthand},
\bibfield{shorttitle}, and \bibfield{shortmaintitle}.

Using this option with \opt{noformat:<field>} allows you to work with
...
titles. Supported values of \bibfield{<field>}: \bibfield{title},
\bibfield{blogtitle}, \bibfield{bookbooktitle}, \bibfield{booktitle},
\bibfield{issuetitle}, \bibfield{journal} (and its equivalent
