% Last modified: Sat 28 Nov 2020 07:29:36 PM CST
...
have an \bibtype{article} entry (see \textit{CMOS} \ref{14.172}). For
forthcoming works, see \textit{CMOS} \ref{14.146}, \ref{14.172}, and
\ref{15.45}. Forthcoming works also print correctly with
\textit{forthcoming} in the \bibfield{year} field, as previous
versions of the style required.
