% Last modified: Sun 28 Mar 2021 06:27:59 PM CDT
...
\opt{swaptrans:series}, respectively. See also section
\ref{edtranspos}.
...
uses standard data fields. The list below sheds light on a selection
of fields that may raise more questions than others.
...
and enclosing the date in parentheses. But for magazine and newspaper
articles, the issue number needs to go first, and the date shouldn't
be in parentheses. The workaround is to include a \bibfield{type}
field with the value \textit{newsmag}. For an example, see
\textit{CMOS} \ref{14.204} and compare it with the citation of Beattie
in \ref{14.171}.
...
such as \opt{swaptrans} and \opt{swapauth}, may determine whether
