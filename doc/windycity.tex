% Last modified: Thu 10 Jan 2019 11:50:51 AM CST
...
above also apply to compilers: If a work has compilers and
translators, Windy City will print compilers' names first, unless you
...
scope of an entry.\footnote{For \bibfield{editor}, exceptions are
possible with the use of \bibfield{editortype}.} For most sources,
then, you can assign editors and translators simply by adding the
\bibfield{editor} and \bibfield{translator} fields to a database
...
volumes. That's not necessarily a typo, but it's inconsistent with
\ref{14.118}, which Windy City follows instead.
