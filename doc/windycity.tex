% Last modified: Fri 03 Dec 2021 06:12:48 PM CST
...
% This list used to combine type aliases (or hard aliases) and soft
% aliases, but users don't need to know about the latter.
...
%\item[\smash{\tshortstack[l]{blogtitle\\blogsubtitle}}]

\item[blogtitle] The name of a blog goes in \bibfield{blogtitle} and
\bibfield{blogsubtitle}. Keep in mind that blog posts take the usual
\bibfield{title} and \bibfield{subtitle} fields.
