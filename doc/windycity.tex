% Last modified: Wed 13 Oct 2021 07:53:58 AM CDT
...
\item[typeaddon] For \bibtype{unpublished} entries in bibliographies
and reference lists, this field adds arbitrary content between the
\bibfield{type} field (with values such as \textit{lecture} or
\textit{paper}) and where it was delivered. Without it, Windy City
follows \bibfield{type} with a comma. From \textit{CMOS} \ref{14.217}:

\begin{bibonly}
\nocite{hong2015.alt}
\nocite{teplin2005.alt}
\end{bibonly}

\noindent When \bibfield{typeaddon} contains \textit{presented at
the}:
...
Without using the optional \bibfield{typeaddon} field:

\begin{citebib}
\item \cite{hong2015.alt}
\item \cite{teplin2005.alt}
\end{citebib}

When \bibfield{typeaddon} contains \textit{presented at the}:
