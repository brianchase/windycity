% Last modified: Sun 07 Feb 2021 01:56:17 PM CST
...
by}. The same goes for compilers, expanders, revisers, and updaters,
which the style treats as specialized editors. For more information,
see section \ref{edtranspos}.
...
The style supports a second tier of editors after a \bibfield{title}
field when no other \bibfield{title} is available for the assignment.
If the style recognizes a second tiers of editors, \bibfield{editor}
precedes \bibfield{editora}, and \bibfield{editora} preceedes
\bibfield{editorb}. (This features excludes \bibfield{editorc}.)
Further, the second editor always prints after \bibfield{title}, even
when the first occupies the author's position.
...
\bibfield{editora} to the next one. Failure to assign a second tier of
editors is more likely to happen with double or triple
cross-referencing. That's rarely necessary, but it no doubt affects
some works in collections.
...
edex & editor and expander & transex & translator and expander\\
edrev & editor and reviser & transrev & translator and reviser\\
...
title's compilers, expanders, revisers, and updaters and for any title
at a higher level than \bibfield{title}, you need to use
...
you to just one set of compilers, expanders, revisers, and updaters.
...
(\textit{transcomp}, \textit{transed}, \textit{transrev}, or
\textit{transup}), Windy City will assume that the translator's role
goes first.
