% Last modified: Sun 09 May 2021 01:12:36 PM CDT
...
% Bibliography option 'short' sets 'short' and 'shortfirst' toggles to
% true. Set them to true to simulate the 'short' bibliography option.
...
% Bibliography option 'short' sets 'short' and 'shortfirst' toggles to
% true. Bibliography option 'ibid' sets 'ibid', 'ibidpage', and
% 'short' toggles to true. Set all those toggles to true to simulate
% the 'short' and 'ibid' bibliography options.
